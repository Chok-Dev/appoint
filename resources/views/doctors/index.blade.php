                            ...
                            @foreach($doctors as $doctor)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <div class="btn-group">
                                            <a href="{{ route('doctors.show', $doctor) }}" class="btn btn-sm btn-alt-secondary" data-toggle="tooltip" title="ดูรายละเอียด">
                                                <i class="fa fa-eye"></i>
                                            </a>
                                            <a href="{{ route('doctors.edit', $doctor) }}" class="btn btn-sm btn-alt-secondary" data-toggle="tooltip" title="แก้ไข">
                                                <i class="fa fa-pencil-alt"></i>
                                            </a>
                                            <button type="button" class="btn btn-sm btn-alt-secondary" data-bs-toggle="modal" data-bs-target="#modal-delete-{{ $doctor->id }}" data-toggle="tooltip" title="ลบ">
                                                <i class="fa fa-trash"></i>
                                            </button>
                                        </div>
                                        
                                        <!-- Delete Modal -->
                                        <div class="modal fade" id="modal-delete-{{ $doctor->id }}" tabindex="-1" role="dialog" aria-labelledby="modal-delete-{{ $doctor->id }}" aria-hidden="true">
