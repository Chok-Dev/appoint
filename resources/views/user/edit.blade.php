        ...
        <form action="{{ route('users.update', $user) }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" id="role_user" name="role" value="user" {{ (old('role', $user->role) === 'user') ? 'checked' : '' }}>
                    <label class="form-check-label" for="role_user">ผู้ใช้งานทั่วไป</label>
                </div>
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" id="role_admin" name="role" value="admin" {{ (old('role', $user->role) === 'admin') ? 'checked' : '' }}>
