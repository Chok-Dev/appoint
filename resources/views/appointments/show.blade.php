...
@section('content')
            ...
            <div class="table-responsive">
              <table class="table table-bordered">
                <tr>
                  ...
                  <td>{{ $appointment->patient_pname }} {{ $appointment->patient_fname }}
                    {{ $appointment->patient_lname }}</td>
                </tr>
                <tr>
          ...
          <div class="col-md-12">
            <div class="d-flex">
              @if ($appointment->status == 'pending')
                ...
                <button type="button" class="btn btn-alt-danger me-2" data-bs-toggle="modal"
                  data-bs-target="#modal-cancel">
                  <i class="fa fa-times me-1"></i> ยกเลิกการนัดหมาย
                </button>
              @endif

              <a href="{{ route('appointments.print', $appointment) }}" class="btn btn-alt-info me-2" target="_blank">
                <i class="fa fa-print me-1"></i> พิมพ์ใบนัด
              </a>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <p>
            <strong>ผู้ป่วย:</strong> {{ $appointment->patient_pname }} {{ $appointment->patient_fname }}
            ...
            <strong>เวลา:</strong> {{ \Carbon\Carbon::parse($appointment->timeSlot->start_time)->format('H:i') }} -
  ...
  @if (Auth::user()->isAdmin())
    <!-- Status Modal -->
    <div class="modal fade" id="modal-status" tabindex="-1" role="dialog" aria-labelledby="modal-status"
      aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            ...
            <div class="modal-body">
              <div class="mb-4">
                ...
                <select class="form-select" id="status" name="status">
                  ...
                  <option value="confirmed" {{ $appointment->status == 'confirmed' ? 'selected' : '' }}>ยืนยันแล้ว
                  </option>
